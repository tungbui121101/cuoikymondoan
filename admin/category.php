...
if (isset($_POST["btnTim"])) {
    ...
    $sqlcategory = "SELECT * from hang where tenhang like '%" . $tim . "%'";
} else {
    $sqlcategory = "SELECT * FROM hang";
}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $categoryList = executeResult($sqlcategory);
                                        foreach ($categoryList as $item) {
                                            echo '<tr>
                                                        <td>' . $item['tenhang'] . '</td>
                                                        <td> <img src=' . $item['logo'] . ' height="100" width-max="100" alt="Khong tai duoc"> </td>   
                                                        <td> 
                                                            <form method="post" action="xoa_category.php">
